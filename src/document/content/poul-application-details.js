  ...
  return {
    stack: [
      { text: 'You have applied for funding for:', margin: [0, 10, 0, 6] },
      {
        ul: [
          {
            text: 'poultry biosecurity checks',
      ...
      { text: 'Agreement details', style: 'subheader', margin: [0, 20, 0, 7] },
      {
        table: {
          body: [
            ...
            [
              {
                text: 'Biosecurity check deadline:',
                margin: [0, 10, 0, 10]
              },
              {
                text: '31 March 2027. You must do all your biosecurity checks by this date.',
                margin: [0, 10, 0, 10]
              }
            ],
            [
              ...
              {
                text: '10 June 2027. You must submit all your claims by this date.',
                margin: [0, 10, 0, 10]
              }
            ]
          ]
      ...
      { text: 'Guidance', style: 'subheader', margin: [0, 20, 0, 7] },
      {
        ul: [
          {
            text: 'Get funding to improve poultry biosecurity',
