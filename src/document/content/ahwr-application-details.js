  ...
  return {
    stack: [
      { text: 'You have applied for funding for:', margin: [0, 10, 0, 6] },
      {
        ul: [
          {
            text: 'animal health and welfare reviews',
          ...
          {
            text: 'endemic disease follow-ups',
            link: 'https://www.gov.uk/guidance/farmers-how-to-apply-for-funding-to-improve-animal-health-and-welfare#endemic-disease-follow-up',
            decoration: 'underline',
            color: '#1D70B8',
            margin: [15, 0, 0, 5]
          }
      ...
      { text: 'Agreement details', style: 'subheader', margin: [0, 20, 0, 7] },
      {
        table: {
          body: [
            ...
            [
              {
                text: 'Review and follow-up deadline:',
                margin: [0, 10, 0, 10]
              },
              {
                text: '19 June 2027. You must do all your reviews and follow-ups by this date.',
                margin: [0, 10, 0, 10]
              }
            ],
            [
              ...
              {
                text: '19 September 2027. You must submit all your claims by this date.',
                margin: [0, 10, 0, 10]
              }
            ]
          ]
      ...
      { text: 'You must:', margin: [0, 0, 0, 6] },
      {
        ul: [
          {
            text: 'do all your reviews and follow-ups on the same species',
            margin: [15, 0, 0, 5]
          },
          {
            text: [
          ...
          },
          {
            text: [
              ...
              {
                text: 'timing of reviews and follow-ups',
      ...
      { text: 'Guidance', style: 'subheader', margin: [0, 20, 0, 7] },
      {
        ul: [
          {
            text: 'Get funding to improve animal health and welfare',
